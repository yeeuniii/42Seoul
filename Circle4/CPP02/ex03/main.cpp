...
int main(void)
{
	...
	std::cout << bsp(Point(Fixed(), Fixed()), Point(Fixed(4), Fixed(0)), Point(Fixed(2), Fixed(4)), Point(Fixed(2), Fixed(4))) << std::endl;
	std::cout << bsp(Point(Fixed(), Fixed()), Point(Fixed(4), Fixed(0)), Point(Fixed(2), Fixed(4)), Point(Fixed(3), Fixed(0))) << std::endl;
